...
\bibitem{Chandy} Chandy, K. M., \& Misra, J., ``The Drinking Philosophers Problem", \emph{ACM Transactions on Programming Languages and Systems}, 1984.
\bibitem{Sequential} Dijkstra, E.W., ``Hierarchical Ordering of Sequential Processes", \emph{Acta-Informatica}, 1971.
\bibitem{Dijkstra} Dijkstra, E.W., ``EWD625". \emph{Plataanstrat}, 1976.
\bibitem{Dinosaur} Silberschatz, Abraham, Galivn, Peter Gaer, \& Gagne, Greg``Operating System Concepts, Ninth Edition", \emph{Wiley and Sons}, 2013.
